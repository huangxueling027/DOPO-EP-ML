# -*- coding: utf-8 -*-
"""Compare formulation prediction with molecular-first screening mode."""
...
def main() -> None:
    ...
    parser.add_argument("--tasks", default="LOI,PHRR,THR,Tg,Char_yield,TS_MPa,FS_MPa")
    ...
    parser.add_argument("--results", type=Path, default=ROOT / "results" / "scientific_validation" / "FINAL_screening_mode_sensitivity_5x5")
    ...
    subprocess.run([
        ...
        "--screening-modes", "formulation,molecular",
        "--bde-modes", "without",
